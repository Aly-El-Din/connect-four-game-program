...
8-You could your game also from one of the three files saved.
9-If the grid is full, the game ends but you undo the whole grid again to change moves.
10-After ending the game, if there is a winner, enter your name to be compared to the list of high score players.
11-the score is being calculated if you connect four games 'x' of 'o' horizontally or vertically or diagonally(from left or right).
